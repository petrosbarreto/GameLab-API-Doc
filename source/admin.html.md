...
`users_by_phase` | string| optional | User's progress phase.
`users_by_pain` | string| optional | User's pain.
`users_by_state` | string| optional | User's state.
`users_by_city` | string| optional | User's city.
`start_date` | string | optional | Works with `users_by_{field}`. `YYYY-MM-DD` format.
`end_date` | string | optional | Works with `users_by_{field}`. `YYYY-MM-DD` format.